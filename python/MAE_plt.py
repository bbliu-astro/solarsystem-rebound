#!/usr/bin/env python
### two examples of four and finve planet systems with gas and plt dis
### Figure 3 of Liu_etal_2021
...
#wdir = '../sim/fiducial/C5MCR/output703' old data
wdir = '../sim/example/'
savedir = '../figure/'
outname = 'example_plt'

filenum0 = 703 # file number list
iplot = filenum0 
nump = 4     # number of planets
...
### system AMD and RMC ###
rmc_0 = RMC(samplemass_0, samplesemi_0, 4)
...
### make plots ###     
fig, ((ax1,ax2),(ax3,ax4)) = plt.subplots(2,2,figsize=(12,8),   gridspec_kw={'width_ratios':[3,1]}, num= 0 )
fig.subplots_adjust(wspace=0.16)
fig.subplots_adjust(hspace=0.12)
ax1.plot(time1[::4],semi1[::4],'m',linewidth=3,alpha=0.7)
ax1.plot(time2[::4],semi2[::4],'darkorange',linewidth= 3,alpha=0.7)
ax1.plot(time3[::4],semi3[::4],'b',linewidth= 3,alpha=0.7)
ax1.plot(time4[::4],semi4[::4],'forestgreen',linewidth= 3,alpha=0.7)
ax1.legend(('Jupiter','Saturn','Uranus','Neptune','ice giant'),frameon=True,loc='upper left', bbox_to_anchor=(0.01,0.95), fontsize=9)
ax1.plot(x98[1:],y98[1:],'k',linewidth=1.5,linestyle='dashed')
ax1.plot(time1[::4],apo1[::4],'m',linewidth= 0.5,alpha=0.7 )
ax1.plot(time1[::4],peri1[::4],'m',linewidth= 0.5,alpha=0.7 )
ax1.plot(time2[::4],apo2[::4],'darkorange',linewidth= 0.5,alpha=0.7)
ax1.plot(time2[::4],peri2[::4],'darkorange',linewidth= 0.5,alpha=0.7 )
ax1.plot(time4[::4],apo4[::4],'forestgreen',linewidth= 0.5,alpha=0.7 )
ax1.plot(time4[::4],peri4[::4],'forestgreen',linewidth= 0.5,alpha=0.7 )
ax1.plot(time3[::4],apo3[::4],'b',linewidth= 0.5,alpha=0.7 )
ax1.plot(time3[::4],peri3[::4],'b',linewidth= 0.5,alpha=0.7 )

ax1.text(1.1e+5,60,'(a)',fontsize=12)
...
workdir = cdir+'/../figure/'
# old source = 'sim/plt/example1/run32'
source = 'example1'
...
colors = ['m','darkorange','b','forestgreen','r', 'darkblue','indigo','brown','khaki',
...
for i in range(nplanet):
    ...
    ax11.plot(time,semi,color=colors[i],linewidth=3,alpha=0.7)
    ax11.plot(time,apo,color=colors[i],linewidth= 0.5,alpha=0.7)
    ax11.plot(time,peri,color=colors[i],linewidth= 0.5,alpha=0.7 )
...
ax11.errorbar(1.13e+8, 19.2, yerr= [19.2*0.046], ms = 4, mfc='b', mec='b',ecolor='b',fmt='s',capthick =2.,capsize = 1.,alpha=0.7 )
ax11.errorbar(1.13e+8, 30.1, yerr= [30.1*0.009], ms =  4, mfc='forestgreen', mec='forestgreen',ecolor='forestgreen',fmt='s',capthick =2.,capsize = 1.,alpha=0.7 )
...
ax11.text(1.1e+7,50,'$M_{\\rm plt}=10 \\ M_{\\oplus}$', fontsize=11)
...
namd_f_20 = 7.494345028881873e-05
rmc_f_20 = 19.966170433068395
namd_f_10 = 0.000243
rmc_f_10 =  23.44
namd_f_5 = 0.00034
rmc_f_5 = 26.84
...
ax2.set_ylim(7,47)
ax2.text(3.6e-7,45,'(b)',fontsize=12)
...
### make plots ###     
ax3.plot(time1[::4],semi1[::4],'m',linewidth=3,alpha=0.7)
ax3.plot(time2[::4],semi2[::4],'darkorange',linewidth= 3,alpha=0.7)
ax3.plot(time3[::4],semi3[::4],'forestgreen',linewidth= 3,alpha=0.7)
ax3.plot(time4[::4],semi4[::4],'b',linewidth= 3,alpha=0.7)
ax3.plot(time5[::2],semi5[::2],'grey',linewidth= 3,alpha=0.7)
ax3.legend(('Jupiter','Saturn','Neptune','Uranus','Ice giant'),frameon=True,loc='upper left', bbox_to_anchor=(0.001,0.94), fontsize=9)
ax3.plot(x98[1:],y98[1:],'k',linewidth=1.5,linestyle='dashed')
ax3.plot(time1[::4],apo1[::4],'m',linewidth= 0.5,alpha=0.7 )
ax3.plot(time1[::4],peri1[::4],'m',linewidth= 0.5,alpha=0.7 )
ax3.plot(time2[::4],apo2[::4],'darkorange',linewidth= 0.5,alpha=0.7)
ax3.plot(time2[::4],peri2[::4],'darkorange',linewidth= 0.5,alpha=0.7 )
ax3.plot(time3[::4],apo3[::4],'forestgreen',linewidth= 0.5,alpha=0.7 )
ax3.plot(time3[::4],peri3[::4],'forestgreen',linewidth= 0.5,alpha=0.7 )
ax3.plot(time4[::4],apo4[::4],'b',linewidth= 0.5,alpha=0.7 )
ax3.plot(time4[::4],peri4[::4],'b',linewidth= 0.5,alpha=0.7 )
ax3.plot(time5[::4],apo5[::4],'grey',linewidth= 0.5,alpha=0.7)
ax3.plot(time5[::4],peri5[::4],'grey',linewidth= 0.5,alpha=0.7 )

ax3.text(1.02e+5,60,'(c)',fontsize=12)
ax3.set_ylabel('$ {\\rm Semimajor \\ axis \\ [AU]}$',fontsize=fs1)
ax3.set_xlim(tmin,tmax)
ax3.set_ylim(amin,amax)
ax3.semilogy()
ax3.set_yticks([5,10,20,40])
ax3.set_yticklabels(['$5$','$10$','$20$','$40$'],fontsize=fs1)
if xlog == True:
  ax3.semilogx()
...
colors = ['m','darkorange','forestgreen','b','r', 'darkblue','indigo','brown','khaki',
    'lime','pink','#8c564b', '#e377c2', '#bcbd22', '#17becf',]
for i in range(nplanet):
    filename = sourcedir+ 'Planet'+ str(i+1)
    time, semi, ecc, inc, apo, peri, mass = readdata(filename)
    ...
    sampleecc_f.append(ecc[-1])
    sampleinc_f.append(inc[-1])
    ax31.plot(time,semi,color=colors[i],linewidth=3,alpha=0.7)
    ax31.plot(time,apo,color=colors[i],linewidth= 0.5,alpha=0.7)
    ax31.plot(time,peri,color=colors[i],linewidth= 0.5,alpha=0.7 )

rmc_f = RMC(samplemass_f, samplesemi_f, 4)
amd_f, namd_f = AMD(samplemass_f,samplesemi_f,sampleecc_f,sampleinc_f,4)

ax31.tick_params(axis='both',which='both', top = True, right =True, labelright=False,labeltop= False)

   ### current solar system ###
ax31.errorbar(1.13e+8, 5.2, yerr= [5.2*0.048], ms =4, mfc='m', mec='m',ecolor='m',fmt='s',capthick =2.,capsize = 1. )
ax31.errorbar(1.13e+8, 9.6, yerr= [9.6*0.057], ms =4, mfc='darkorange', mec='darkorange',ecolor='darkorange',fmt='s',capthick =2.,capsize = 1. )
ax31.errorbar(1.13e+8, 19.2, yerr= [19.2*0.046], ms = 4, mfc='b', mec='b',ecolor='b',fmt='s',capthick =2.,capsize = 1.,alpha=0.7 )
ax31.errorbar(1.13e+8, 30.1, yerr= [30.1*0.009], ms =  4, mfc='forestgreen', mec='forestgreen',ecolor='forestgreen',fmt='s',capthick =2.,capsize = 1.,alpha=0.7 )
ax3.text(1.31e+5,4.3,'$disk \\ inner \\ edge$',fontsize =10,rotation=0)

ax3.set_xticks([1e+5,3e+5,1e+6,3e+6,1e+7])
ax3.set_xticklabels(['$0.1$','$0.3$','$1$','$3$','$10$'],fontsize=fs1)
ax31.set_xticks([3.e+7,5e+7,7e+7,9e+7,1.1e+8])
ax31.set_xticklabels(['$30$','$50$','$70$','$90$','$110$'],fontsize=fs1)
...
ax31.text(1.1e+7,60,'${\\bf planetesimal \\  disk} $', fontsize=11)
ax31.text(1.1e+7,50,'$M_{\\rm plt}=5 \\ M_{\\oplus}$', fontsize=11)
ax3.text(5.1e+5,60,'$\\bf gas \\  disk \\ dispersal $', fontsize=11)

fig.text(0.4,0.05, '$\\rm Time \\ [Myr]$', ha = 'center', fontsize=fs1)
...
rmcSS = RMC(SSmass, SSsemi, 4)
amdSS, namdSS = AMD(SSmass,SSsemi,SSecc,SSinc,4)
ax4.scatter(namdSS, rmcSS, s=150, c='r', edgecolors='none', marker='*')
ax4.scatter(namd_0, rmc_0, s=100, c='grey', edgecolors='none', marker='^',alpha=0.5)
ax4.scatter(namd_m, rmc_m, s=100, c='grey', edgecolors='none', marker='^')
...
ax4.scatter(namd_f_5, rmc_f_5, s=100, c='pink', edgecolors='none', marker='^',alpha=0.8)
ax4.scatter(namd_f_10, rmc_f_10, s=100, c='brown', edgecolors='none', marker='^',alpha=0.7)
ax4.scatter(namd_f_20, rmc_f_20, s=100, c='purple', edgecolors='none', marker='^',alpha=1)

ax4.semilogx()
ax4.set_xlim(3e-7,1.e-2)
ax4.set_xticks([1e-6,1e-4,1e-2])
ax4.set_xticklabels(['$10^{-6}$','$10^{-4}$','$10^{-2}$'],fontsize=13)

### add label ###
ax4.set_ylabel('$\\rm RMC $',fontsize=fs1)
ax4.set_xlabel('$\\rm AMD$',fontsize=fs1)
ax4.set_ylim(7,47)
ax4.text(7e-7,45,'(d)',fontsize=12)
ax4.set_yticks([10,20,30,40])
ax4.set_yticklabels(['$10$','$20$','$30$','$40$'],fontsize=13)
