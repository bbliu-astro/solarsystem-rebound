...
### Extended Data Figure 10 of Liu_etal_2021
...
#
    ...
    plt.errorbar(5.03e+6, 19.2, yerr= [19.2*0.046], ms = 4, mfc='b', mec='b',ecolor='b',fmt='s',capthick =2.,capsize = 1. )
    plt.errorbar(5.03e+6, 30.1, yerr= [30.1*0.009], ms =  4, mfc='forestgreen', mec='forestgreen',ecolor='forestgreen',fmt='s',capthick =2.,capsize = 1. )
