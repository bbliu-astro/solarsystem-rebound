...
for iplot in range(filenum0,filenum+1):
    ...
    plt.errorbar(2.03e+6, 19.2, yerr= [19.2*0.046], ms = 4, mfc='forestgreen', mec='forestgreen',ecolor='forestgreen',fmt='s',capthick =2.,capsize = 1. )
    plt.errorbar(2.03e+6, 30.1, yerr= [30.1*0.009], ms =  4, mfc='b', mec='b',ecolor='b',fmt='s',capthick =2.,capsize = 1. )
