#!/usr/bin/env python
### an example of 4-planet system with gas and plt dis
### Figure 3a of Liu_etal_2021
...
ax1.plot(time4[::4],semi4[::4],'forestgreen',linewidth= 3,alpha=0.8)
ax1.legend(('Jupiter','Saturn','Uranus','Neptune','ice giant'),frameon=True,loc='upper left', bbox_to_anchor=(0.01,0.95), fontsize=10)
...
ax1.plot(time3[::4],apo3[::4],'b',linewidth= 0.5,alpha=0.6 )
ax1.plot(time3[::4],peri3[::4],'b',linewidth= 0.5,alpha=0.6 )
ax1.plot(time4[::4],apo4[::4],'forestgreen',linewidth= 0.5,alpha=0.6 )
ax1.plot(time4[::4],peri4[::4],'forestgreen',linewidth= 0.5,alpha=0.6 )
...
colors = ['m','darkorange','blue','forestgreen','r', 'darkblue','indigo','brown','khaki',
...
ax11.text(1.1e+7,52,'$M_{\\rm plt}=10 \\ M_{\\oplus}$', fontsize=11)
